              ...
              <div className="col-span-11 ps-16 w-full relative top-[-16px]">
                ...
                <div>
                  ...
                  <ul className="list-disc mt-4 relative left-4 flex flex-col gap-2">
                    <li className="dark:text-white/70" >主動提出自動化電腦審計作業的方案，利用Python pyrfc套件 搭配 SAP RFC連線，自動化下載客戶SAP設定檔。可省去手動下載的時間3小時</li>
                    <li className="dark:text-white/70" >協助審計團隊年報查核任務，編寫審計軟體ACL Script，驗算4家公司會計系統是否有效，並提供審計團隊要求之特定異常分錄，可於要求時間提前3至4日交付成果</li>
                    <li className="dark:text-white/70" >輔導3家公司建立內部控制制度，並為其執行公開發型內部控制專審，1家已成功興櫃</li>
                    <li className="dark:text-white/70" >完成24家公司資訊技術一般控制審計(ITGC)專案，提供會計師團隊公司資訊部門查核風險以利規劃後續審計任務，審查報告皆準時交付與會計師團隊</li>
                  </ul>
                </div>
              </div>
            ...
            <li 
              ...
              <div className="col-span-11 ps-16 w-full relative top-[-16px]">
                ...
                <div>
                  <p><span className="font-bold">公司簡述：</span>PwC為排名世界第二的會計師事務所，主要業務為財報審計、風險管理、法律服務等</p>
                  <ul className="list-disc mt-4 relative left-4 flex flex-col gap-2">
                    <li className="dark:text-white/70" >助查核團隊年報查核事項，負責5家公司翻閱憑證、操作ERP與撰寫底稿等相關工作</li>
                  </ul>
                </div>
              </div>
              <div className="col-span-1 relative">
