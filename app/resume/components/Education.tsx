    ...
    <section className="mt-16 mb-8">
      ...
      <div className="outside-box w-full mt-12">
        <div className="mx-auto relative w-full md:w-11/12">
          <ul className="w-full">
            <li 
              className=" border-l-2 pd-2 pb-12 relative md:grid md:grid-cols-12 gap-4 border-gray-300 before:absolute before:left-[-7px] before:-top-1 before:content-[' '] before:rounded-full before:bg-gray-300 before:w-3 before:h-3">
              <div className="col-span-11  ps-4 lg:ps-16  w-full relative top-[-16px]">
                ...
                <div>
                  <ul className="list-disc mt-4 relative left-4 flex flex-col gap-2">
                    <li className="text-white/70" >5 篇<Link target='_blank' className="text-sky-300 hover:bg-gray-500" href='/blogs/tech'>技術筆記</Link>於medium獲得 105 位viewers</li>
                  </ul>
                </div>
              </div>
                ...
                <div>
                  <ul className="list-disc mt-4 relative left-4 flex flex-col gap-2">
                    <li className="text-white/70" >
                      ...
                      <Link  target='_blank'  className="text-sky-300 hover:bg-gray-500" href="https://tdr.lib.ntu.edu.tw/bitstream/123456789/8399/1/U0001-1204202115134100.pdf">
                        利用深度學習預測審計失敗--以台灣為例
                      </Link>
