      ...
      <div className="md:grid md:grid-cols-2 flex flex-col gap-8">
        <div className="md:col-span-1 grid grid-cols-6 gap-4">
          ...
          <div className="col-span-5">
            <p className="ms-1 text-gray-300">
              2021 年 10 月
            </p>

            <Link target='_blank' className="font-bold text-lg hover:bg-gray-500 text-sky-300" href="/pdf/resume/會計師及格通知書.pdf">
              會計師高等考試及格證書
            </Link>
        ...
        <div className="md:col-span-1 grid grid-cols-6 gap-4">
          ...
          <div className="col-span-5">
            ...
            <Link target='_blank' className="font-bold text-lg hover:bg-gray-500 text-sky-300" href="/pdf/resume/日語N3_JEPT證書.pdf">
              日本語能力測驗 N3（JLPT N3）
            </Link>
            <p className="text-white/70 text-lg">
